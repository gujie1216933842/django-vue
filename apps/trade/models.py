...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name='交易流水号')
    pay_status = models.DateTimeField(choices=ORDER_STATUS, max_length=10, verbose_name='订单支付状态')
